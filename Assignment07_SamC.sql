...
-- 2/27/2022 Ching Sam, Created File
-- 3/1/2022 Ching Sam, Completed Assignment
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_SamC')
	 Begin 
	  Alter Database [Assignment07DB_SamC] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_SamC;
	 End
	Create Database Assignment07DB_SamC;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_SamC;
...
AS
 SELECT TOP 1000000
    ...
    InventoryDate,
    InventoryCount,
    [PreviousMonthCount] = IIF(Month(InventoryDate) = 1, 0 , (Lag(InventoryCount) Over (Order By ProductName)))
